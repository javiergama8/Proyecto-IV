				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<h2>FUNCIONAMIENTO<span> ¿En qué consiste?¿Cómo funciona?</span></h2>
			...
			<div class="body7">
				<div class="main">
					<section id="content">
						...
						<div id="logoAyuda"><img src="images/ayudaImage.png" alt=""></div>
						<style>
							#logoAyuda {margin-left:-90px}
						</style>
						
						<div id="textoAyuda">
							<div style="color:#000099; font-size:350%;"><p>Si solamente deseas buscar</p><center><p> algún tipo de enlace...</p></center></div><br><br>
							<p><b>1.</b> Piensa que es lo que deseas consultar.</p>
							<p><b>2.</b> Busca entre nuestras secciones.</p>
							<p><b>3.</b> Y una vez que hayas elegido una sección, accede a cualquiera de nuestros enlaces.</p>
							<p><b>4.</b> Podrás encontrar cualquier cosa.</p><br><br>
							
							<div style="color:#000099; font-size:350%;"><p>Si por el contrario deseas</p><center><p> añadir enlaces a la web...</p></center></div><br><br>
							
							<p><b>1.</b> Registrate como usuario en nuestra web rellenando el formulario de registro.</p>
							<p><b>2.</b> Si ya perteneces a nuestra comunidad de usuarios, ya podrás hacer nuevas aportaciones con tus <b>enlaces</b>.</p>
							<p><b>3.</b> Para ello, una vez estés logueado, accede al apartado <b>Enlaza-me</b>.</p>
							<p><b>4.</b> Una vez dentro, simplemente rellena los campos correspondientes con <b>URL</b> y <b>Título</b>.</p>
							<p><b>5.</b> Después de todo esto, nuestro enlace estará publicado en la web en la sección <b>USUARIOS</b>, que será donde se almacenen todos los enlaces aportados por los usuarios de la web.</p><br><br>
							
						</div>
						
						<style>
							#textoAyuda {margin-left: 220px; margin-top: -150px; font-size:110%}
						</style>
