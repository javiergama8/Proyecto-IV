		...
		<!-- contenido -->
			...
			<div class="body7">
				<div class="main">
					...
					<div style="font-size: 190%; margin-bottom: 30px; margin-top: -3px; font: oblique bold 250% cursive"><p>LOS ENLACES QUE HE AGREGADO SON: </p></div>
				
							<?php
							  $perfil = mysql_query("SELECT * FROM enlacesUsuarios WHERE nombre='".$_SESSION['usuario_nombre']."'") or die(mysql_error());
							...
							echo "<div style='margin-left:570px;'>";
							echo "<lu>";
							echo" <li style='cursor:pointer' title='LEquipe' onclick='window.open('url')'><h2><span>$row[2]</span></h2></li>";
							echo"$row[1]<br>";
							echo "</lu>";
							echo "</div>";
							...
							<div style="margin-top: -150px; margin-left: -100px;position:relative">
