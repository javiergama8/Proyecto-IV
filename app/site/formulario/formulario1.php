	...
	?>
					...
					<section id="content">
							...
							<section id="formulario">
								 <div style="font-size: 350%; margin-top: 20px; margin-bottom: 55px; font-weight:bold; color: #000099;   text-decoration: underline; font: oblique bold 350% cursive; ">Formulario</div>
							<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
								 
							<fieldset style="border: 3px dashed #000099;width:80%;background:#81BEF7;color:#ffffff; margin-left: 100px; margin-top: -10px">
							...
							<fieldset style="border: 3px dashed #000099;width:80%;background:#81BEF7;color:#ffffff; margin-left: 100px; ">
								 ...
								 <input id="botonesAbajo" type="submit" name="enviar" class="myButton" value="Registrar" />
