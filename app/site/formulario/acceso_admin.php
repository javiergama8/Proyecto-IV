				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<h2>ADMINISTRADOR<span> Añade o elimina los enlaces que desees</span></h2>
				...
				<div class="main">
					<section id="content">
							...
							<?php
							 	if(empty($_SESSION['usuario_nombre'])) { // comprobamos que las variables de sesión estén vacías        
							?>
								 <center> <form action="comprobar_admin.php" method="post">
								 <fieldset>
								 <legend><div ><h2>Datos de acceso Administrador</h2></div></legend>
										<div id="cuadro"><label><div style="margin-top: 20px;  color: #000099;" ><b>Usuario:</b></label><br />
										<input type="text" name="administrador_nombre" /><br /></div>
										<label style=" color: #000099;"><b>Contraseña:</b></label><br />
										<input type="password" name="administrador_clave" /><br />
									  <br><br>
										<input id="botonesAbajo" type="submit" name="enviar" class="myButton" value="Ingresar" /></div>
								 </fieldset>
								  </form> </center>  
						...
						?>
								  <p>Hola <strong><?=$_SESSION['administrador_nombre']?></strong> | <a href="logout_administrador.php">Salir</a></p>
						<?php
							 }
						?>  
