					...
					<header>
						...
						<nav id="menu">
							<ul>
								...
								<li class="nav5"><a href="formulario1.php">REGISTRO</a></li>
							</ul>
						</nav>
					</header>
					</div>
				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<h2>ACCESO<span> Introduce usuario y contraseña</span></h2>
				...
				<div class="main">
					<section id="content">
					 ...
					 <?php
							 if(empty($_SESSION['usuario_nombre'])) { // comprobamos que las variables de sesión estén vacías        
						?>
								 <center> <form action="comprobar.php" method="post">
								 <fieldset>
								 <legend><h2>Datos de acceso</h2></legend><br>
										<div id="cuadro" style=" color: #000099;"><label><b>Usuario:</b></label><br />
										...
										<br><input id="botonesAbajo" type="submit" name="enviar" class="myButton" value="Ingresar" /></div>
								 </fieldset>
								  </form> </center>
