				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/tecnologiaOrdenado.png" alt=""></figure>
							<h2>TECNOLOGÍA<span> Los avances tecnológicos actuales</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
							  <ul>
								 ...
								 <li style="cursor:pointer" title="Muy Interesante" onclick="window.open('http://www.muyinteresante.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1NnFjNTMwUFZVQ3M) no-repeat center left;background-size:16px 16px;padding-left:25px;">MuyInteresante</span></h2></li>
								 
								 
								 <li style="cursor:pointer" title="GeekSroom" onclick="window.open('http://www.geeksroom.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1LS1jYmFwRnoxOHM) no-repeat center left;background-size:16px 16px;padding-left:25px;">Geeksroom</span></h2></li>
								 
								 <li style="cursor:pointer" title="Alt1040" onclick="window.open('http://alt1040.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1QzlGSi1tOUZlOTg) no-repeat center left;background-size:16px 16px;padding-left:25px;">Alt1040</span></h2></li>
								 
								 <li style="cursor:pointer" title="WWWHatSnew" onclick="window.open('http://wwwhatsnew.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1LWhJMjdxcXR4LUU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Wwwhatsnew</span></h2></li>
								 
								 <li style="cursor:pointer" title="Error500" onclick="window.open('http://www.error500.net/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cUtoRkdMWWdZMG8) no-repeat center left;background-size:16px 16px;padding-left:25px;">Error500</span></h2></li>
								 
								 <li style="cursor:pointer" title="FayerWayer" onclick="window.open('http://www.fayerwayer.com/es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1MnJxMlQ2WEo4MkE) no-repeat center left;background-size:16px 16px;padding-left:25px;">Fayerwayer</span></h2></li>
								 
								 <li style="cursor:pointer" title="GizModo" onclick="window.open('http://www.gizmodo.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WWM1b3FvbTJJNE0) no-repeat center left;background-size:16px 16px;padding-left:25px;">Gizmodo</span></h2></li>
								 
								 
								 <li style="cursor:pointer" title="Actualidad Iphone" onclick="window.open('http://www.actualidadiphone.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1dHdXZUtrT0VLbGM) no-repeat center left;background-size:16px 16px;padding-left:25px;">Actualidadiphone</span></h2></li>
								 
								 <li style="cursor:pointer" title="GsmSpain" onclick="window.open('http://www.gsmspain.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cUNwT252RmZ1bDA) no-repeat center left;background-size:16px 16px;padding-left:25px;">Gsmspain</span></h2></li>
								 
								 <li style="cursor:pointer" title="XatakaMovil" onclick="window.open('http://www.xatakamovil.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1YjRxODZVcUlUZ0U) no-repeat center left;background-size:16px 16px;padding-left:25px;">Xatakamovil</span></h2></li>
								 
								 <li style="cursor:pointer" title="El android Libre" onclick="window.open('http://www.elandroidelibre.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1YVYxVHVHdVFlSUE) no-repeat center left;background-size:16px 16px;padding-left:25px;">Elandroidelibre</span></h2></li>
								 
								 <li style="cursor:pointer" title="Bitelia" onclick="window.open('http://bitelia.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1My14UFFtUURQVFU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Bitelia</span></h2></li>
								 
								 <li style="cursor:pointer" title="Desarrollo Web" onclick="window.open('http://desarrolloweb.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZGdja0tqQTVSR2M) no-repeat center left;background-size:16px 16px;padding-left:25px;">Desarrolloweb</span></h2></li>
								 
								 <li style="cursor:pointer" title="Adsl Zone" onclick="window.open('http://www.adslzone.net')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1X0VJZmVTUGxsaEU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Adslzone</span></h2></li>
								 
								 
								 <li style="cursor:pointer" title="InfoSpyware" onclick="window.open('http://www.infospyware.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1NTUwaEVrS3lodDA) no-repeat center left;background-size:16px 16px;padding-left:25px;">Infospyware</span></h2></li>
								 
								 
								 <li style="cursor:pointer" title="enGadget" onclick="window.open('http://es.engadget.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WklMZU8xQTB6V2s) no-repeat center left;background-size:16px 16px;padding-left:25px;">EnGadget</span></h2></li>
								 
								 <li style="cursor:pointer" title="Tu experto" onclick="window.open('http://www.tuexperto.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1VnpiUVdCbzNvOEk) no-repeat center left;background-size:16px 16px;padding-left:25px;">Tuexperto</span></h2></li>
								 
								 <li style="cursor:pointer" title="IteSpresso" onclick="window.open('http://www.itespresso.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1VHczYUFpU0FUUFE) no-repeat center left;background-size:16px 16px;padding-left:25px;">Itespresso</span></h2></li>
								 
								 
								 <li style="cursor:pointer" title="Pc-World" onclick="window.open('http://www.pcworld.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1NGw1ZlRYYWNZa00) no-repeat center left;background-size:16px 16px;padding-left:25px;">PC-World</span></h2></li>
								 
								 <li style="cursor:pointer" title="Computing" onclick="window.open('http://www.computing.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1c3dpLU5md0Mzc0k) no-repeat center left;background-size:16px 16px;padding-left:25px;">Computing</span></h2></li>
								 
								 <li style="cursor:pointer" title="Comunicaciones hoy" onclick="window.open('http://www.comunicacioneshoy.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cEcyUGwzWE04Mzg) no-repeat center left;background-size:16px 16px;padding-left:25px;">Comunicacioneshoy</span></h2></li>
								 
								 <li style="cursor:pointer" title="Channel Biz" onclick="window.open('http://www.channelbiz.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1eFZud0p4UlJidkU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Channelbiz</span></h2></li>
								 
								 <li style="cursor:pointer" title="Tendencias" onclick="window.open('http://www.tendencias21.net')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZDBuYW5UT0wyQk0) no-repeat center left;background-size:16px 16px;padding-left:25px;">Tendencias 21</span></h2></li>
