		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/peliculas.png" alt=""></figure>
							<h2>PELÍCULAS<span> </span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 ...
									 <li style="cursor:pointer" onclick="window.open('http://www.youtube.com/user/YouTubeMoviesES')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=youtube.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Youtube Pelis</span></h2><p>Una gran variedad de películas</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.classiccinemaonline.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=classiccinemaonline.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 ClassicCinema</span></h2><p>Si te gusta el cine clásico</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.dcine.org/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=dcine.org) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Dcine</span></h2><p>Red social sobre cine</p></li>

								  
									 <li style="cursor:pointer" onclick="window.open('http://www.imdb.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=imdb.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Imdb</span></h2><p>la mayor base de datos de cine</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.filmin.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/filimin.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Filmin</span></h2><p>cine, peliculas online </p></li>
									 <li style="cursor:pointer" onclick="window.open('http://wuaki.tv/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/wuaki.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Wuaki</span></h2><p>tu videoclub en casa, con algunas películas gratuitas</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.nubeox.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=nubeox.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Nubeox</span></h2><p>Servicio para ver cine en casa</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.netflix.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/netflix.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Netflix</span></h2><p>catálogo de series y películas para ver por internet</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.estrenosdtl.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/estrenosdtl.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 EstrenosDTL</span></h2><p>peliculas online</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.divxtotal.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/divxtotal.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Divxtotal</span></h2><p>peliculas online</p></li>

									 <li style="cursor:pointer" onclick="window.open('http://www.utorrent.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=utorrent.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Utorrent</span></h2><p>para compartir</p></li>
