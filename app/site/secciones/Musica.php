				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/radioImage.png" alt=""></figure>
							<h2>MÚSICA<span> Las mejores páginas de música.</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								 <ul>	
									 ...
									 <li style="cursor:pointer" onclick="window.open('http://www.spotify.com/es/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/spotify.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Spotify</span></h2><p>uno de los más populares para escuchar música, necesita instalación</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.europafm.com/artistas')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.europafm.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 EuropaFm-artistas</span></h2><p>ranking de artistas musicales</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.vevo.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.vevo.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Vevo</span></h2><p>Videos musicales, conciertos, estrenos</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.youtube.com/music')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.youtube.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Music</span></h2><p>Recopilación de los videos musicales más vistos</p></li>
									 
									 

									 <li style="cursor:pointer" onclick="window.open('http://www.deezer.com/es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.deezer.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Deezer</span></h2><p>contiene un gran surtido de títulos musicales</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.lastfm.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.lastfm.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Last.fm</span></h2><p>radio por internet con un gran catálogo de temas musicales</p></li>

									 <li style="cursor:pointer" onclick="window.open('http://www.yes.fm/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/yes.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Yes.fm</span></h2><p>música, con una gran cantidad de canciones a tu disposición</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.mixcloud.com')"><h2><span style="background:url(http://1.bp.blogspot.com/-5r9bSLTaVZ0/UV2mb_NnrpI/AAAAAAAABIg/MEZMNAtqHhE/s320/mixcloud.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Mixcloud</span></h2><p>los mejores DJs</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.jamendo.com/es/')"><h2><span style="background:url(http://4.bp.blogspot.com/-fq17S_7gXvc/UV2mYkpPL6I/AAAAAAAABGo/gtplTzXE6Kg/s320/jamendo.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Jamendo</span></h2><p>recopilación de música libre y gratis</p></li>

									 
									 
									 <li style="cursor:pointer" onclick="window.open('http://rara.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/rara.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Rara</span></h2><p>Toda la música del mundo sin anuncios (necesita registro).</p></li>

									 <li style="cursor:pointer" onclick="window.open('http://www.mixrad.io/es/es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=nokia.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 MixRadio</span></h2><p>consulta, compra el top de novedades musicales</p></li>

									 <li style="cursor:pointer" onclick="window.open('http://www.mtvmusica.es')"><h2><span style="background:url(http://4.bp.blogspot.com/-szNaWk1V_Uw/UV2mb8Q82fI/AAAAAAAABIo/DXtuROIpbjA/s320/mtv.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 MtvMusica</span></h2><p>videos musicales de esta conocida cadena de televisión</p></li>
									 
									 
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.funradio.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.funradio.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 FunRadio</span></h2><p>música dance, videos, noticias ...</p></li>
									 


									 <li style="cursor:pointer" onclick="window.open('http://www.hispasonic.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/hispasonic.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Hispasonic</span></h2><p>Música, sonido y tecnología</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.musica.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.musica.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Musica</span></h2><p>si estas buscando la letra de una canción estas es tu página, además de mp3, etc ...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.midomi.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/midomi.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Midomi</span></h2><p>busca una canción tarareándola ...</p></li>

									 <li style="cursor:pointer" onclick="window.open('http://www.conciertos10.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.conciertos10.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Conciertos10</span></h2><p>para estar informado de todos los conciertos que hay</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://los40.com/lista40/')"><h2><span style="background:url(http://2.bp.blogspot.com/-QIJgl-iQC7Q/UV2mRtr1ffI/AAAAAAAABCY/DoC0ZAL8_3s/s320/40principales.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Los40-lista</span></h2><p>lista musical de los 40 principales</p></li>
