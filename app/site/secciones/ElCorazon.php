				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/corazonImage.png" alt=""></figure>
							<h2>EL CORAZÓN<span> Noticias y cotilleos actualizados</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
							  <ul>
								 ...
								 <li style="cursor:pointer" title="Revistas del corazón" onclick="window.open('http://revistas.kiosko.net')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1SG9waDFWRHo2bXc) no-repeat center left;background-size:16px 16px;padding-left:25px;">Revistas</span></h2></li>
								 
								 <li style="cursor:pointer" title="Hola" onclick="window.open('http://www.hola.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1YU95QS1nbTNJdU0) no-repeat center left;background-size:16px 16px;padding-left:25px;">Hola</span></h2></li>
								 
								 <li style="cursor:pointer" title="Diez Minutos" onclick="window.open('http://www.diezminutos.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1OTRiU3R4dW52UmM) no-repeat center left;background-size:16px 16px;padding-left:25px;">DiezMinutos</span></h2></li>
								 
								 <li style="cursor:pointer" title="Semana" onclick="window.open('http://www.semana.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1N0UyRXFJbXpfaVk) no-repeat center left;background-size:16px 16px;padding-left:25px;">Semana</span></h2></li>
								 
								 <li style="cursor:pointer" title="Revista Cuore" onclick="window.open('http://www.revistacuore.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1V1JtbHBJN2NjNTQ) no-repeat center left;background-size:16px 16px;padding-left:25px;">RevistaCuore</span></h2></li>
								 
								 <li style="cursor:pointer" title="Lecturas" onclick="window.open('http://www.lecturas.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WWdrVG5yWWJzUU0) no-repeat center left;background-size:16px 16px;padding-left:25px;">Lecturas</span></h2></li>

								 <li style="cursor:pointer" title="Que Me dices" onclick="window.open('http://quemedices.diezminutos.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1TFNDUnRXMV9vRjg) no-repeat center left;background-size:16px 16px;padding-left:25px;">QueMeDices</span></h2></li>
								 
								 <li style="cursor:pointer" title="Divinity" onclick="window.open('http://www.divinity.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Yjhwdk4tRFhCY1E) no-repeat center left;background-size:16px 16px;padding-left:25px;">Divinity</span></h2></li>

								 
								 <li style="cursor:pointer" title="People" onclick="window.open('http://www.peopleenespanol.com')"><h2><span class="noexiste">People</span></h2></li>
								 
								 <li style="cursor:pointer" title="Mas Corazon" onclick="window.open('http://www.mascorazon.com')"><h2><span class="noexiste">Mascorazon</span></h2></li>
