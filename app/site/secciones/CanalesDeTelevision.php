				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/televisionImage.png" alt=""></figure>
							<h2>CANALES<span> Disfruta de todos los canales de televisión</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
									  <ul>
										 ...
										 <li style="cursor:pointer" onclick="window.open('http://www.antena3.com')"><h2><span style="background:url(http://4.bp.blogspot.com/-wcH2U7xLIPU/T4E9mW6DDwI/AAAAAAAAARs/-9oUCkT0_eY/s200/antena3.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Antena 3</span></h2><p>nacional</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.cuatro.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=cuatro.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Cuatro</span></h2><p>nacional</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.telecinco.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.telecinco.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Telecinco</span></h2><p>nacional</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.lasexta.com')"><h2><span style="background:url(http://3.bp.blogspot.com/-X_UDdejVEUs/T4E9z4pEflI/AAAAAAAAAR4/TyBEHscbfAI/s200/lasexta.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 La Sexta</span></h2><p>nacional</p></li>
										 
										 
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.telemadrid.es')"><h2><span style="background:url(http://3.bp.blogspot.com/--nRz9ZVIC3Y/UV2mgPXDkqI/AAAAAAAABLU/VfxZyqTL0qw/s320/telemadrid.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Telemadrid</span></h2><p>autonómico comunidad de madrid</p></li>
								
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.rtve.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.rtve.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Televisión Española</span></h2><p>nacional</p></li>
										 
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.canalsur.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/canalsur.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Canal Sur</span></h2><p>autonómico andalucía</p></li>
										 
									
										 <li style="cursor:pointer" onclick="window.open('http://www.intereconomia.com')"><h2><span style="background:url(http://3.bp.blogspot.com/-t0PzmZxhJmw/UV2mYSjVbXI/AAAAAAAABGk/pag8mpVFZ-8/s320/intereconomia.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Intereconomía</span></h2><p>intereconomía</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://home.disney.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=disney.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Disney Channel</span></h2><p>Disney España</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.plus.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=plus.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Canal+</span></h2><p>plus</p></li>
										 
										
										
										 <li style="cursor:pointer" onclick="window.open('http://www.axn.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=axn.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Axn</span></h2><p>AXN España.</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.foxtv.es')"><h2><span style="background:url(http://3.bp.blogspot.com/-iGhq8bb7NwA/UV2mWz9E61I/AAAAAAAABFg/w456hkOfk7w/s320/foxtv.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Fox Tv</span></h2><p>Fox tv</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.nationalgeographic.es')"><h2><span style="background:url(http://3.bp.blogspot.com/-ZPgpYTaUUC0/UV2mcUbPgzI/AAAAAAAABJA/RjJjoylXh94/s320/nationalgeographic.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 NationalGeographic</span></h2><p>National Geographic España</p></li>
										 
										 <li style="cursor:pointer" onclick="window.open('http://www.discovery.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=discovery.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 DiscoveryChannel</span></h2><p>Science, History, Space, Tech, Sharks, News</p></li>
