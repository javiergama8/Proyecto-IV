				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/blogImage.png" alt=""></figure>
							<h2>BLOGS<span> Lee, aprende y crea tus propios Blogs</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 ...
									 <li style="cursor:pointer" title="Bitácora" onclick="window.open('http://bitacoras.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WVJNZHVFcS01OXc) no-repeat center left;background-size:16px 16px;padding-left:25px;">Bitácoras</span></h2></li>
									 
									 <li style="cursor:pointer" title="Que es un blog" onclick="window.open('http://www.blogger.com/tour_start.g')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1b1VJbnJSVHNGRjg) no-repeat center left;background-size:16px 16px;padding-left:25px;">QueEsUnBlog</span></h2></li>
									 
									 <li style="cursor:pointer" title="Blogger" onclick="window.open('https://www.blogger.com/start')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1b1VJbnJSVHNGRjg) no-repeat center left;background-size:16px 16px;padding-left:25px;">Blogger </span></h2></li>
									 
									 <li style="cursor:pointer" title="WordPress" onclick="window.open('http://es.wordpress.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZWY1clI0MWhjY0E) no-repeat center left;background-size:16px 16px;padding-left:25px;">Wordpress</span></h2></li>
									 
									 <li style="cursor:pointer" title="La coctelera" onclick="window.open('http://www.lacoctelera.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZHNObXpxbzBsWTA) no-repeat center left;background-size:16px 16px;padding-left:25px;">Lacoctelera</span></h2></li>
									 
									 <li style="cursor:pointer" title="PrestaShop" onclick="window.open('https://www.prestashop.com/blog/es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1MC1UZ2xYV3hrVHM) no-repeat center left;background-size:16px 16px;padding-left:25px;">PrestaShop</span></h2></li>
