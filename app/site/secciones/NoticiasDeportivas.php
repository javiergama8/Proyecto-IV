				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/deportes.png" alt=""></figure>
							<h2>PERIODISMO<span> Todo sobre deportes</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
		     					<ul>
									 ...
									 <li style="cursor:pointer" title="Marca" onclick="window.open('http://www.marca.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1LXU1LXNmQ1R0Zk0) no-repeat center left;background-size:16px 16px;padding-left:25px">Marca</span></h2></li>
									 
									 <li style="cursor:pointer" title="As" onclick="window.open('http://www.as.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Um1qU3hScDBtRUU) no-repeat center left;background-size:16px 16px;padding-left:25px">As</span></h2></li>
									 
									 <li style="cursor:pointer" title="Sport" onclick="window.open('http://www.sport.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1S0FOMi0zNGs3bWM) no-repeat center left;background-size:16px 16px;padding-left:25px">Sport</span></h2></li>
									 
									 <li style="cursor:pointer" title="Mundo Deportivo" onclick="window.open('http://www.elmundodeportivo.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1b1JySnlucmhLRWc) no-repeat center left;background-size:16px 16px;padding-left:25px">MundoDeportivo</span></h2></li>
									 
									 <li style="cursor:pointer" title="Liga BBVA" onclick="window.open('http://www.ligabbva.com')"><h2><span class="noexiste">LigaBBVA</span></h2></li>

									 <li style="cursor:pointer" title="EuroSport" onclick="window.open('https://es.eurosport.yahoo.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WVROVFZHdjltZEk) no-repeat center left;background-size:16px 16px;padding-left:25px;">EuroSport</span></h2></li>
									 
									 <li style="cursor:pointer" title="Goal" onclick="window.open('http://www.goal.com/es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1LW9XdnU5eWpWZVk) no-repeat center left;background-size:16px 16px;padding-left:25px;">Goal</span></h2></li>
									 
									 <li style="cursor:pointer" title="Todos los fichajes" onclick="window.open('http://www.fichajes.net')"><h2><span class="noexiste">Todo Fichajes</span></h2></li>
									 
									 <li style="cursor:pointer" title="Resultados-Futbol" onclick="window.open('http://www.resultados-futbol.com')"><h2><span class="noexiste">Resultados-futbol</span></h2></li>
									 
									 <li style="cursor:pointer" title="Fórmula 1" onclick="window.open('http://www.caranddriverthef1.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZC1MX1RUUDlFQ1k) no-repeat center left;background-size:16px 16px;padding-left:25px;">Caranddriverf1</span></h2></li>
									 
									 <li style="cursor:pointer" title="Moto GP" onclick="window.open('http://www.motogp.com/es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1dEh1UGNyR0t2bjQ) no-repeat center left;background-size:16px 16px;padding-left:25px;">Moto GP</span></h2></li>
									 
									 <li style="cursor:pointer" title="Motor 21" onclick="window.open('http://www.motor21.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1SzV1YnRHeEU0SUU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Motor21</span></h2></li>
									 
									 <li style="cursor:pointer"  title="ACB" onclick="window.open('http://www.acb.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1VUNqRGFSUUk0MEU) no-repeat center left;background-size:16px 16px;padding-left:25px;">Acb</span></h2></li>
									 
									 <li style="cursor:pointer" title="Fórmula 1" onclick="window.open('http://www.formula1.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1dWE2aEp5d0lhRGs) no-repeat center left;background-size:16px 16px;padding-left:25px;">F1</span></h2></li>	
									 
									 <li style="cursor:pointer" title="NBA" onclick="window.open('http://www.nba.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ZXFZWHZFcnF5OGs) no-repeat center left;background-size:16px 16px;padding-left:25px;">Nba</span></h2></li>
									 
									 <li style="cursor:pointer" title="L'Equipe" onclick="window.open('http://www.lequipe.fr')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1TUdZbTF2aWlyQ0E) no-repeat center left;background-size:16px 16px;padding-left:25px">L'equipe</span></h2></li>
