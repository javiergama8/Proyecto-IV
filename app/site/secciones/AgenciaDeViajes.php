		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/avion.png" alt=""></figure>
							<h2>AGENCIA DE VIAJES<span> Planificica tus vacaciones</span></h2>
							<h1>Tus viajes mas baratos</h1>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
							  <ul>
								 <li style="cursor:pointer" onclick="window.open('http://www.viajar.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=viajar.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Viajar</span></h2><p>Vuelos, Hoteles, Viajes y Vacaciones</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.eDreams.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=edreams.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 eDreams</span></h2><p>Viajes, vuelos, hoteles, vacaciones</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://destinia.com')"><h2><span style="background:url(http://3.bp.blogspot.com/-0V1f-1BlxGk/UV2mUhR7JbI/AAAAAAAABEE/jyzejlL2Ksw/s320/destinia.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Destinia</span></h2><p>ofertas Hoteles Vuelos Apartamentos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.travelgenio.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/travelgenio.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 TravelGenio</span></h2><p>Agencia de Viajes Online</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.rumbo.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=rumbo.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Rumbo</span></h2><p>Vuelos, viajes, hoteles y vacaciones.</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.expedia.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=expedia.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Expedia</span></h2><p>Reserva hoteles, vuelos, viajes y paquetes de vacaciones baratos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.VuelosBaratos.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/VuelosBaratos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Vuelos Baratos</span></h2><p>Buscador de Vuelos Baratos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.logitravel.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.logitravel.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Logitravel</span></h2><p>Ofertas de Viajes, Hoteles, Vuelos baratos, Cruceros</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.halconviajes.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=halconviajes.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 HalconViajes</span></h2><p>Vacaciones y Ofertas de viajes</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.muchoviaje.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.muchoviaje.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 MuchoViaje</span></h2><p>ofertas, Viajes, hoteles, vacaciones</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.barceloviajes.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/barceloviajes.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Barcelo Viajes</span></h2><p>Viajes Vuelos baratos, ofertas Esquí</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.costacruceros.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.costacruceros.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Costa Cruceros</span></h2><p>Vacaciones en Crucero, Cruceros por el Mediterraneo</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.viajeseroski.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/viajeseroski.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 ViajesEroski</span></h2><p>Viajes Eroski  EROSKI-viajes</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.viajeselcorteingles.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.elcorteingles.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 El Corte Ingles</span></h2><p>Hoteles, vuelos, tren, vacaciones, ofertas viajes</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.aireuropa.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=aireuropa.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Aireuropa</span></h2><p>AirEuropa</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.airfrance.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=airfrance.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Airfrance</span></h2><p>Billetes de Avión, ofertas de vuelos a París, USA, Asia</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.americanairlines.com')"><h2><span style="background:url(http://1.bp.blogspot.com/-RkCcU_nmf5g/UV2mSM2ElmI/AAAAAAAABCs/COt_zSmJmVI/s320/americanairlines.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Americanairlines</span></h2><p>vuelos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.britishairways.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/british.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Britishairways</span></h2><p>Hotels, Holidays, Car Rental</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.easyjet.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=easyjet.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Easyjet</span></h2><p>Reserva vuelos baratos y ofertas de última hora</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.iberia.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=iberia.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Iberia</span></h2><p>Los Mejores Precios en vuelos</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.ryanair.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=ryanair.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Ryanair</span></h2><p>Vuelos baratos a Europa</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.lufthansa.es')"><h2><span style="background:url(http://1.bp.blogspot.com/-GcUoDbYPVLA/UV2ma6udaWI/AAAAAAAABH4/lMBd-hBiLZE/s320/lufthansa.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Lufthansa</span></h2><p>vuelos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.klm.com')"><h2><span style="background:url(http://4.bp.blogspot.com/-unGbVkdBrzo/UV2mZlYAujI/AAAAAAAABHU/2w6mNcDMxK4/s320/klm.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Klm</span></h2><p>vuelos</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.lan.com')"><h2><span style="background:url(http://2.bp.blogspot.com/-9k2O5sxac7o/UV2mZ8Y28sI/AAAAAAAABHQ/WyuJMIRuoWw/s320/lan.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Lan</span></h2><p>Vuelos a Chile, Perú, Argentina, Ecuador, España y Latinoamérica</p></li>
