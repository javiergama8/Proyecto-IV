		...
		<!-- content -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/cine.png" alt=""></figure>
							<h2>CINE<span> No te pierdas los nuevos estrenos.</span></h2>
							<h1>Encuentra cualquier película que quieras ver.</h1>
					...
					<section id="content">
							...
							<div id="iniciales" class="subindices1">
								 <ul>	
									...
									<li style="background:url(http://4.bp.blogspot.com/-oYE9LL3c9WE/T4FE2ZgrDKI/AAAAAAAAATA/c6ywQ921OFY/s200/news.png) no-repeat  center left;" onclick="javascript:window.location.href='ActualidadCine.php'">Actualidad</li>
									
									<li style="background:url(http://1.bp.blogspot.com/-szYgwaLzMY4/T4FIWTe82AI/AAAAAAAAAVo/cvODByvXpeI/s200/canales.png) no-repeat  center left;" onclick="javascript:window.location.href='Peliculas.php'">Películas</li>
									
									<li style="background:url(http://4.bp.blogspot.com/-TvXrcoq_c4Q/UbEAJbRWfGI/AAAAAAAABas/r1XdPAqE9bo/s1600/enelcine.png) no-repeat  center left;" onclick="javascript:window.open('http://www.ecartelera.com/cartelera/')">Cartelera de tu ciudad</li>
									
									<li style="background:url(http://4.bp.blogspot.com/-TvXrcoq_c4Q/UbEAJbRWfGI/AAAAAAAABas/r1XdPAqE9bo/s1600/enelcine.png) no-repeat  center left;" onclick="javascript:window.open('http://hoycinema.abc.es/estrenos/')">Ver últimos estrenos</li>
									
					  			<li style="background:url(http://4.bp.blogspot.com/-TvXrcoq_c4Q/UbEAJbRWfGI/AAAAAAAABas/r1XdPAqE9bo/s1600/enelcine.png) no-repeat  center left;" onclick="javascript:window.open('http://www.trailerland.net/')">Todos los trailers</li>
