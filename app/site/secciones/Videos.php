				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/videoImage.png" alt=""></figure>
							<h2>VÍDEOS<span> Los mejores vídeos de la web</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								 <ul>	
									 ...
									 <li style="cursor:pointer" onclick="window.open('http://www.youtube.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.youtube.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Youtube</span></h2><p>la mayor colección de videos ...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.vimeo.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.vimeo.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Vimeo</span></h2><p>compartiendo videos para tí ...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.elrellano.com')"><h2><span style="background:url(http://2.bp.blogspot.com/-YuA6pQ_iXOQ/UV2mVmZhS9I/AAAAAAAABEk/LB5gkAJr3-o/s320/elrellano.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 ElRellano</span></h2><p>recopilación de videos de humor y audios divertidos</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.terra.tv')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=terra.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Terra.tv</span></h2><p>Videos y películas online gratis</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://tu.tv')"><h2><span class="noexiste">
									 Tu.tv</span></h2><p>recopilación de videos en internet</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.imdb.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.imdb.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Imdb</span></h2><p>la mayor base de datos sobre películas</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.dailymotion.com/es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/dailymotion.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Dailymotion</span></h2><p>vídeos, música y películas, con selección de videos para cada día</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.metacafe.com')"><h2><span class="noexiste">
									 Metacafe</span></h2><p>los mejores videos y películas de internet</p></li>
