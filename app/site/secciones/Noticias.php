				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/leer.png" alt=""></figure>
							<h2>PERIODISMO<span> Conoce las últimas noticias</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
		    					<ul>
									 ...
									 <li style="cursor:pointer" title="Kiosko" onclick="window.open('http://kiosko.net/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=kiosko.net) no-repeat center left;background-size:16px 16px;padding-left:25px;">Kiosko</span></h2></li> 
									 <li style="cursor:pointer" title="Bitácoras" onclick="window.open('http://bitacoras.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.bitacoras.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">Bitácoras</span></h2></li>
									 <li style="cursor:pointer" title="El Mundo" onclick="window.open('http://www.elmundo.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.elmundo.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Elmundo</span></h2></li>  
									 <li style="cursor:pointer" title="El País" onclick="window.open('http://www.elpais.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.elpais.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Elpais</span></h2></li>
									 <li style="cursor:pointer" title="20minutos" onclick="window.open('http://www.20minutos.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.20minutos.es) no-repeat center left;background-size:16px 16px;padding-left:25px">20minutos</span></h2></li>  
									 <li style="cursor:pointer" title="Que!" onclick="window.open('http://www.que.es')"><h2><span style="background:url(http://4.bp.blogspot.com/-B5AJ8VwvEo4/UV2mdx14OcI/AAAAAAAABJ8/NgMrgvuogo8/s320/que.png) no-repeat center left;background-size:16px 16px;padding-left:25px">Que!</span></h2></li>
									 <li style="cursor:pointer" title="La Razón" onclick="window.open('http://www.larazon.es')"><h2><span class="noexiste">Larazon</span></h2></li>
									 <li style="cursor:pointer" title="Libertad digital" onclick="window.open('http://www.libertaddigital.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=libertaddigital.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Libertaddigital</span></h2></li>
									 <li style="cursor:pointer" title="Abc" onclick="window.open('http://www.abc.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.abc.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Abc</span></h2></li>
									 <li style="cursor:pointer" title="El cofidencial" onclick="window.open('http://www.elconfidencial.com')"><h2><span style="background:url(http://1.bp.blogspot.com/-An08ONMaidk/UV2mVq484VI/AAAAAAAABEs/uWuslW2YrTg/s320/elconfidencial.png) no-repeat center left;background-size:16px 16px;padding-left:25px">Elconfidencial</span></h2></li>
									 <li style="cursor:pointer" title="Público" onclick="window.open('http://www.publico.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.publico.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Publico</span></h2></li>
									 <li style="cursor:pointer" title="Estrella digital" onclick="window.open('http://www.estrelladigital.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.estrelladigital.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Estrelladigital</span></h2></li>
									 <li style="cursor:pointer" title="El imparcial" onclick="window.open('http://www.elimparcial.es')"><h2><span class="noexiste">Elimparcial</span></h2></li>
									 <li style="cursor:pointer" title="Periodista Digital" onclick="window.open('http://www.periodistadigital.com/')"><h2><span class="noexiste">Periodistadigital</span></h2></li>
									 <li style="cursor:pointer" title="La Información" onclick="window.open('http://www.lainformacion.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.lainformacion.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Lainformacion</span></h2></li>
									
									 <li style="cursor:pointer" title="Noticias" onclick="window.open('http://www.noticias.com')"><h2><span style="background:url(http://2.bp.blogspot.com/-kf1a7VbCwJU/UV2mcsZ7jWI/AAAAAAAABI8/aa89hT6-QnM/s320/noticias.png) no-repeat center left;background-size:16px 16px;padding-left:25px">Noticias</span></h2></li>
									 <li style="cursor:pointer" title="EuropaPress" onclick="window.open('http://www.europapress.es')"><h2><span class="noexiste">Europapress</span></h2></li>
									 <li style="cursor:pointer" title="Diario crítico" onclick="window.open('http://www.diariocritico.com/')"><h2><span class="noexiste">Diariocritico</span></h2></li>
									 <li style="cursor:pointer" title="La vanguardia" onclick="window.open('http://www.lavanguardia.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.lavanguardia.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Lavanguardia</span></h2></li>
									 <li style="cursor:pointer" title="El periódico" onclick="window.open('http://www.elperiodico.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.elperiodico.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Elperiodico</span></h2></li>
									 <li style="cursor:pointer" title="La voz de Galicia" onclick="window.open('http://www.lavozdegalicia.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.lavozdegalicia.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Lavozdegalicia</span></h2></li>
			
									 <li style="cursor:pointer" title="El comercio" onclick="window.open('http://www.elcomercio.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.elcomerciodigital.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Elcomercio</span></h2></li>
									 
									 
									 <li style="cursor:pointer" title="Diario Información" onclick="window.open('http://www.diarioinformacion.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.diarioinformacion.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Diarioinformacion</span></h2></li>
									 <li style="cursor:pointer" title="Las provincias" onclick="window.open('http://www.lasprovincias.es/')"><h2><span class="noexiste">Lasprovincias</span></h2></li>
									 <li style="cursor:pointer" title="Levante" onclick="window.open('http://www.levante-emv.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.levante-emv.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Levante-emv</span></h2></li>
									 <li style="cursor:pointer" title="El día digital" onclick="window.open('http://eldiadigital.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.eldiadigital.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Eldiadigital</span></h2></li>
									 
									 <li style="cursor:pointer" title="La verdad" onclick="window.open('http://www.laverdad.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.laverdad.es) no-repeat center left;background-size:16px 16px;padding-left:25px">Laverdad</span></h2></li>
									 <li style="cursor:pointer" title="Madrid diario" onclick="window.open('http://www.madridiario.es/')"><h2><span class="noexiste">Madridiario</span></h2></li>
									 <li style="cursor:pointer" title="La huella digital" onclick="window.open('http://www.lahuelladigital.com/')"><h2><span class="noexiste">Lahuelladigital</span></h2></li>
									 <li style="cursor:pointer" title="El digital de Madrid" onclick="window.open('http://www.eldigitaldemadrid.es')"><h2><span class="noexiste">Eldigitaldemadrid</span></h2></li>
									 <li style="cursor:pointer" title="Andalucía información" onclick="window.open('http://www.andaluciainformacion.es')"><h2><span class="noexiste">Andaluciainformacion</span></h2></li>
									 <li style="cursor:pointer" title="La voz digital" onclick="window.open('http://www.lavozdigital.es/')"><h2><span class="noexiste">Lavozdigital</span></h2></li>
									 <li style="cursor:pointer" title="DiarioSur" onclick="window.open('http://www.diariosur.es/')"><h2><span class="noexiste">Diariosur</span></h2></li>
									 <li style="cursor:pointer" title="El ideal" onclick="window.open('http://www.ideal.es/')"><h2><span class="noexiste">Ideal</span></h2></li>
									 <li style="cursor:pointer" title="Diario Jaén" onclick="window.open('http://www.diariojaen.es/')"><h2><span style="background:url(http://3.bp.blogspot.com/-frJz7wY_L0c/UV2mUz43kXI/AAAAAAAABEA/-Wdh5U3uD-c/s320/diariojaen.png) no-repeat center left;background-size:16px 16px;padding-left:25px">Diariojaen</span></h2></li>

									 <li style="cursor:pointer" title="Nytimes" onclick="window.open('http://www.nytimes.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.nytimes.com) no-repeat center left;background-size:16px 16px;padding-left:25px">Nytimes</span></h2></li>
