		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/actualidadCines.png" alt=""></figure>
							<h2>CINE ACTUAL<span> </span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 ...
									 <li style="cursor:pointer" onclick="window.open('http://www.fotogramas.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.fotogramas.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Fotogramas</span></h2><p>actualidad de cine</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.labutaca.net/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=labutaca.net) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 LaButaca</span></h2><p>Estrenos de cine, tráilers de películas, críticas, cartelera</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.hoycinema.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=hoycinema.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 HoyCinema</span></h2><p>Lo mejor del séptimo arte.</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.ecartelera.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=ecartelera.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 eCartelera</span></h2><p>toda la actualidad del cine y la cartelera de tu ciudad</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.filmaffinity.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=filmaffinity.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 FilmAffinity</span></h2><p>tu página de cine</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.estrenosdecine.net')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=estrenosdecine.net) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 EstrenosDeCine</span></h2><p>cine, película, estrenos, trailer, noticias ...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.blogdecine.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=blogdecine.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Blog de cine</span></h2><p>Críticas de películas</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.elmulticine.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/elmulticine.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 ElMulticine</span></h2><p>Cine, películas, estrenos de cartelera.</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://todocine.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/todocine.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Todocine</span></h2><p>Todo el mundo del cine</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.aullidos.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/aullidos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Aullidos</span></h2><p>El portal número 1 de cine de terror y fantástico.</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.trailerland.net/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/trailerland.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Trailers</span></h2><p>Todos los trailers, de la semana, novedades ...</p></li>
