		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/casaRurales.png" alt=""></figure>
							<h2>CASAS RURALES<span> Las mejores casas en la sierra</span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 <li style="cursor:pointer" onclick="window.open('http://www.tuscasasrurales.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/tuscasasrurales.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Casas rurales</span></h2><p>Casas rurales, hoteles rurales, alojamientos rurales y turismo rural</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.clubrural.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/clubrural.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 ClubRural</span></h2><p>Casas rurales  Hoteles rurales  Turismo rural</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.planrural.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/planrural.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 PlanRural</span></h2><p>Alquiler casas rurales, hoteles rurales, turismo rural</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.toprural.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/toprural.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 TopRural</span></h2><p>Casas rurales, turismo rural</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.todaslascasasrurales.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/todaslascasasrurales.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Todaslascasas</span></h2><p>Alquiler casas rurales con encanto</p></li>
									 
									 <li style="cursor:pointer" onclick="window.open('http://www.brujulea.net/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/brujulea.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Brujulea</span></h2><p>Casas rurales con encanto</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.escapadarural.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/escapadarural.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
									 Escapadarural</span></h2><p>Casas rurales</p></li>
