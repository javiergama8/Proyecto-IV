				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/juegosImage.png" alt=""></figure>
							<h2>VIDEOJUEGOS<span> Todas las noticias sobre videojugos</span></h2>
					...
					<section id="content">
							...
							<div id="iniciales" class="subindices1">
								 <ul>	
									...
									<li style="background:url(http://4.bp.blogspot.com/-oYE9LL3c9WE/T4FE2ZgrDKI/AAAAAAAAATA/c6ywQ921OFY/s200/news.png) no-repeat  center left;" onclick="javascript:window.location.href='NoticiasVideoJuegos.php'">Todas las noticias y trucos</li>
									<li style="background:url(http://1.bp.blogspot.com/-szYgwaLzMY4/T4FIWTe82AI/AAAAAAAAAVo/cvODByvXpeI/s200/canales.png) no-repeat  center left;" onclick="javascript:window.location.href='JuegosEnLaRed.php'">Juegos más populares en la red</li>
