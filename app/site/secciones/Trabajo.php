				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/trabajoImage1.png" alt=""></figure>
							<h2>TRABAJO<span> Busca y encuentra trabajo en cualquiera de nuestros enlaces</span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 <li style="cursor:pointer" onclick="window.open('http://www.infojobs.net')"><h2><span class="noexiste">
									 Infojobs</span></h2><p>trabajo, ofertas de empleo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.monster.es/')"><h2><span class="noexiste">
									 Monster</span></h2><p>trabajo. Miles de ofertas de empleo para encontrar tu profesión</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://es.trabajar.com/')"><h2><span class="noexiste">
									 Trabajar</span></h2><p>trabajo, ofertas de empleo y bolsa de trabajo.</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.infoempleo.com/')"><h2><span class="noexiste">
									 Infoempleo</span></h2><p>trabajos y ofertas de empleo.</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.hayseleccion.com')"><h2><span class="noexiste">
									 Hay Selección</span></h2><p>capital humano</p></li>
									 <li style="cursor:pointer" onclick="window.open('https://freelance.infojobs.net/')"><h2><span class="noexiste">
									 Infolancer</span></h2><p>Encuentra profesionales freelance</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.careerbuilder.es/')"><h2><span class="noexiste">
									 Careerbuilder</span></h2><p>ofertas de empleo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.domestiko.com')"><h2><span class="noexiste">
									 Domestiko</span></h2><p>ofertas de empleo doméstico</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.elance.com')"><h2><span class="noexiste">
									 Elance</span></h2><p>freelance professionals</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.laboris.net')"><h2><span class="noexiste">
									 Laboris</span></h2><p>empleo más eficaz, ofertas de trabajo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.randstad.es/')"><h2><span class="noexiste">
									 Randstad</span></h2><p>ofertas de trabajo, empleo, trabajo temporal</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.trabajos.com')"><h2><span class="noexiste">
									 Trabajos</span></h2><p>ofertas de trabajo, bolsa de empleo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.construyendoempleo.com/')"><h2><span class="noexiste">
									 ConstruyendoEmpleo</span></h2><p>fundación laboral de la construcción</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.loquo.com')"><h2><span class="noexiste">
									 LoQuo</span></h2><p>Barcelona, anuncios gratis</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.segundamano.es')"><h2><span class="noexiste">
									 SegundaMano</span></h2><p>anuncios clasificados</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.expansionyempleo.com')"><h2><span class="noexiste">
									 ExpansionyEmpleo</span></h2><p>trabajo y ofertas de empleo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.empleo.com')"><h2><span class="noexiste">
									 Empleo</span></h2><p>ofertas de trabajo, ofertas de empleo</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.wiju.es')"><h2><span class="noexiste">
									 Wiju</span></h2><p>anuncios clasificados ...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.milanuncios.com')"><h2><span class="noexiste">
									 MilAnuncios</span></h2><p>anuncios clasificados...</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.adoos.es')"><h2><span class="noexiste">
									 Adoos</span></h2><p>anuncios clasificados</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.mundoanuncio.com/')"><h2><span class="noexiste">
									 MundoAnuncio</span></h2><p>anuncios clasificados</p></li>
									 <li style="cursor:pointer" onclick="window.open('http://www.jobrapido.es')"><h2><span class="noexiste">
									 Jobrapido</span></h2><p>todas las ofertas de trabajo publicadas en la web</p></li>
