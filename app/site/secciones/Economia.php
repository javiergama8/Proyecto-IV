				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/economiaImage.png" alt=""></figure>
							<h2>ECONOMÍA<span> Conoce la situación económica en todo momento</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
										...
										<li style="cursor:pointer" title="Expansión" onclick="window.open('http://www.expansion.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1T1FGNDFpX0VzTmM) no-repeat center left;background-size:16px 16px;padding-left:25px">Expansion</span></h2></li>
										
										<li style="cursor:pointer" title="Cinco Días" onclick="window.open('http://www.cincodias.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Sm9uQUttY29pcE0) no-repeat center left;background-size:16px 16px;padding-left:25px">Cincodias</span></h2></li>
										
										<li style="cursor:pointer" title="El economista" onclick="window.open('http://www.eleconomista.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1NU5NcjlWWkItelE) no-repeat center left;background-size:16px 16px;padding-left:25px">Eleconomista</span></h2></li>
										
										<li style="cursor:pointer" title="Cotizalia" onclick="window.open('http://www.elconfidencial.com/mercados/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1RVZfWEM3ZG1wcUE) no-repeat center left;background-size:16px 16px;padding-left:25px">Cotizalia</span></h2></p></li>
										
										<li style="cursor:pointer" title="Euribor" onclick="window.open('http://www.euribor.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1enpXSHo5MG5iUm8) no-repeat center left;background-size:16px 16px;padding-left:25px">Euribor</span></h2></li>
										
										<li style="cursor:pointer" title="Finanzas" onclick="window.open('http://www.finanzas.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Z1dLUHdTQTQtX0U) no-repeat center left;background-size:16px 16px;padding-left:25px">Finanzas</span></h2></li>
										
										<li style="cursor:pointer" title="Invertia" onclick="window.open('http://www.invertia.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1VUk4WGZsV3BqQW8) no-repeat center left;background-size:16px 16px;padding-left:25px;">Invertia</span></h2></li>
										
										<li style="cursor:pointer" title="Bolsa de Madrid" onclick="window.open('http://www.bolsamadrid.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cU55NG9LemU3NjA) no-repeat center left;background-size:16px 16px;padding-left:25px">Bolsamadrid</span></h2></li>
										
										
										<li style="cursor:pointer" title="La bolsa" onclick="window.open('http://www.labolsa.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1X3ZCcWFTQ3k2Qnc) no-repeat center left;background-size:16px 16px;padding-left:25px;">Labolsa</span></h2></li>
										
										<li style="cursor:pointer" title="Inversion" onclick="window.open('http://www.estrategiasdeinversion.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1b0NKRHBSb1ZoT2M) no-repeat center left;background-size:16px 16px;padding-left:25px;">Inversion</span></h2></li>
										
										<li style="cursor:pointer" title="Economist" onclick="window.open('http://www.economist.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Z0VyQkFBUTNpeXc) no-repeat center left;background-size:16px 16px;padding-left:25px">Economist</span></h2></li>
