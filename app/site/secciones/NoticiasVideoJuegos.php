				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/meristation.png" alt=""></figure>
							<h2>VIDEOJUEGOS<span> Todas las noticias y trucos actualizados</span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
									  <ul>
										 <li style="cursor:pointer" onclick="window.open('http://www.meristation.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/meristation.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Meristation</span></h2><p>Revista de videojuegos, trucos y guías en español</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.vidaextra.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/vidaextra.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Vidaextra</span></h2><p>Consolas y videojuegos</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.elotrolado.net')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/elotrolado.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 ElOtroLado</span></h2><p>Consolas, videojuegos, nuevas tecnologías y actualidad</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.juegosdb.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/juegosdb.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Juegosdb</span></h2><p>Revista de Videojuegos, Consolas, Trucos y Guias</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.3djuegos.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/3djuegos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 3djuegos</span></h2><p>videojuegos: PC Xbox 360 PS3 3DS DS Wii PSP</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.vandal.net/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/vandal.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Vandal</span></h2><p>PlayStation 3, Xbox 360, Wii, Nintendo DS, PSP, PlayStation 2</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://es.trenchplay.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/atrincherados.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Atrincherados</span></h2><p>noticias y ventas de videojuegos</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.xbox.com/es-ES')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/xbox.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Xbox</span></h2><p>página oficial de la xbox</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://es.playstation.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/playstation.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 PlayStation</span></h2><p>página oficial de PlayStation</p></li>
										 <li style="cursor:pointer" onclick="window.open('http://www.nintendo.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/nintendo.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										 Nintendo</span></h2><p>página oficial de Nintendo</p></li>
