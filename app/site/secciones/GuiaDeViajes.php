		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/guiasViajes.png" alt=""></figure>
							<h2>GUÍA DE VIAJES<span> Toda la información para ti</span></h2>
					...
					<section id="content">
							<style>
									*           {margin:0;padding:0;}
									...
									#detalleff h2 span {	font-size:20px;}
							...
							<div id="detalleff">
								  <ul>
										<li style="cursor:pointer" onclick="window.open('http://www.losviajeros.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=losviajeros.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Los viajeros</span></h2><p>Portal de Viajes. Foros, Fotografias, ...</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.minube.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=minube.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Minube</span></h2><p>guia para viajar</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.guiarepsol.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.repsol.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guiarepsol</span></h2><p>rutas, callejeros, carreteras, restaurantes, itinerarios</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.viamichelin.es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=viamichelin.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guia Michelín</span></h2><p>Mapas, rutas, carreteras, distancias, callejero</p></li>
										<li style="cursor:pointer" onclick="window.open('http://yotellevo.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/yotellevo.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Yotellevo</span></h2><p>Rutas por carretera. Mapas de carretera.</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.tripadvisor.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=tripadvisor.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Tripadvisor</span></h2><p>Opiniones de hoteles, restaurantes, atracciones y consejos para viajes</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.buscounviaje.com')"><h2><span class="noexiste">
										BuscounViaje</span></h2><p>buscador de viajes con recomendaciones</p></li>
										<li style="cursor:pointer" onclick="window.open('http://mimaleta.com')"><h2><span style="background:url(http://2.bp.blogspot.com/-ts9-mveHs9o/UV2mbv4c0ZI/AAAAAAAABIU/gc3n9v1v5EM/s320/mimaleta.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										MiMaleta</span></h2><p>guia de recomendaciones para viajar</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.tralopia.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/tralopia.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Tralopia</span></h2><p>Guía de viajes, con recomendaciones, opiniones, ...</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.yumping.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=yumping.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Yumping</span></h2><p>Deportes de aventura, ocio</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.todonieve.com')"><h2><span style="background:url(http://4.bp.blogspot.com/-oX4GG9K2Zug/UV2mgj4RXFI/AAAAAAAABLo/eb97fXZo9LY/s320/todonieve.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										TodoNieve</span></h2><p>La web de la nieve y el esqui.</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.skiinfo.es/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/nieveesquiar.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Skiinfo</span></h2><p>ofertas de esquí, comentarios</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.balneariosyspa.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/balnearios.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										BalneariosySpa</span></h2><p>Balnearios, Spa y Turismo de Salud</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.ocholeguas.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=ocholeguas.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Ocholeguas</span></h2><p>portal de viajes</p></li>
										<li style="cursor:pointer" onclick="window.open('http://elviajero.elpais.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=elpais.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Elviajero</span></h2><p>Guía de Viajes</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.travelpeques.com/')"><h2><span style="background:url(http://4.bp.blogspot.com/-PTG049KVG7Q/UV2mhE7ng8I/AAAAAAAABME/catvZ4sg6mU/s320/travelpeques.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										TravelPeques</span></h2><p>Vacaciones con niños, hoteles con niños</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.viajarconhijos.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/viajarconhijos.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Viajarconhijos</span></h2><p>Viajar con Hijos</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.viajarenfamilia.net')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/viajarenfamilia.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Viajarenfamilia</span></h2><p>Viajar en familia</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.viajarsolo.com')"><h2><span style="background:url(http://1.bp.blogspot.com/-ytkQSfGdM3w/UV2mhblkH6I/AAAAAAAABMk/q4aEHpKT3LU/s320/viajarsolo.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										viajarsolo</span></h2><p>viajes para solteros</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.guias-viajes.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/guiasdeviajes.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guias Viajes</span></h2><p>descubre el mundo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.couchsurfing.org')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=couchsurfing.org) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Couchsurfing</span></h2><p>Participate in Creating a Better World</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.cuentatuviaje.net')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/cuentatuviaje.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Cuentatuviaje</span></h2><p>Relatos de viaje,consejos y opiniones</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.elrincondeltrotamundos.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/elrincondeltrotamundos.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Rincón trotamundos</span></h2><p>por todo el mundo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.tusrutasysenderos.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/tusrutasysenderos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Tusrutasysenderos</span></h2><p>las mejores rutas por españa</p></li>
