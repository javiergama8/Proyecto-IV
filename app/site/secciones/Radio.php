				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<h2>RADIO<span> Escucha tu emisora favorita.</span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div class="inicorreo"><br>
								 <ul>
							  	
									<li style="background:url(http://2.bp.blogspot.com/-QIJgl-iQC7Q/UV2mRtr1ffI/AAAAAAAABCY/DoC0ZAL8_3s/s320/40principales.png) no-repeat  top center;" onclick="javascript:window.open('http://www.yes.fm/star/40Principales')">40principales</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.cadena100.es) no-repeat  top center;background-size:16px 16px;" onclick="javascript:window.open('http://player.cadena100.es')">Cadena100</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/cadenadial.jpg) no-repeat  top center;" onclick="javascript:window.open('http://www.yes.fm/star/CadenaDIAL')">Cadenadial</li>
									<li style="background:url(http://4.bp.blogspot.com/-RlSsDvrFPy4/T4E9bXLXXvI/AAAAAAAAARg/88htRLbHU88/s200/kissfm.png) no-repeat  top center;" onclick="javascript:window.open('http://www.kissfm.es/player/kissplayer/index.php')">Kissfm</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/m80radio.png) no-repeat  top center;" onclick="javascript:window.open('http://www.yes.fm/star/M80Radio')">M80radio</li>
									<li style="background:url(http://1.bp.blogspot.com/-fsQxjzwVEKE/UV2mSxDnnhI/AAAAAAAABDA/be6oamemr-c/s320/cadenaser.png) no-repeat  top center;" onclick="javascript:window.open('http://www.cadenaser.com/player_radio.html')">Cadenaser</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/cope.png) no-repeat  top center;" onclick="javascript:window.open('http://www.cope.es')">Cope</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/radioole.jpg) no-repeat  top center;" onclick="javascript:window.open('http://www.yes.fm/star/Radiole')">Radioole</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.europafm.com) no-repeat  top center;background-size:16px 16px;" onclick="javascript:window.open('http://www.europafm.com/directo/')">Europafm</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/ondacero.png) no-repeat  top center;" onclick="javascript:window.open('http://www.ondacero.es/directo/')">Ondacero</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/esradio.png) no-repeat  top center;" onclick="javascript:window.open('http://esradio.libertaddigital.com/')">Esradio</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/maxima.jpg) no-repeat  top center;" onclick="javascript:window.open('http://www.yes.fm/star/MaximaFM')">Maxima</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.rtve.es) no-repeat  top center;background-size:16px 16px;" onclick="javascript:window.open('http://www.rtve.es/radio/')">Rne</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.marca.com) no-repeat  top center;background-size:16px 16px;" onclick="javascript:window.open('http://www.marca.com/deporte/popup/radiomarca/index.html')">Marca</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.tunein.com) no-repeat  top center;background-size:16px 16px;" onclick="javascript:window.open('http://tunein.com/')">Tunein</li>
