		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/viajes.png" alt=""></figure>
							<h2>TURISMO<span> ¿Te gusta viajar?</span></h2>
							<h1>Elige el tipo de viaje que desees.</h1>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="iniciales" class="subindices1">
								 <ul>	

									<li style="background:url(http://2.bp.blogspot.com/-UqZeROezRCM/UQ5krC-58JI/AAAAAAAAA8Q/8vnJUfv01DY/s1600/airplane.png) no-repeat  center left;" onclick="javascript:window.location.href='AgenciaDeViajes.php'">Agencias de viajes</li>
									
									<li style="background:url(http://2.bp.blogspot.com/-TQA4QhyE96Y/UQ5krXfgFjI/AAAAAAAAA8c/OKSEWf7t6_0/s1600/rural.png) no-repeat  center left;" onclick="javascript:window.location.href='CasasRurales.php'">Casas rurales</li>
									
									<li style="background:url(http://3.bp.blogspot.com/-KrwrBDkQXcU/UQ5kroqIQjI/AAAAAAAAA8o/yDxh-Qac6vY/s1600/travel_directions.png) no-repeat  center left;" onclick="javascript:window.location.href='GuiaDeViajes.php'">Guías de viaje</li>
									
									<li style="background:url(http://4.bp.blogspot.com/-A7E4Q22jotk/UQ5ksRhefRI/AAAAAAAAA80/cDdlX5zHoMA/s1600/postcard.png) no-repeat  center left;" onclick="javascript:window.location.href='Lugares.php'">Conoce lugares</li>
									
									<li style="background:url(http://3.bp.blogspot.com/-Lzc-D7VOr8s/UQ5ks6Lbo7I/AAAAAAAAA9A/8c7v9B8oSDU/s1600/hotel_bed.png) no-repeat  center left;" onclick="javascript:window.location.href='SitiosDormir.php'">Sitios donde dormir</li>
									
									<li style="background:url(http://1.bp.blogspot.com/-E3GUgFRXkA8/UQ5lGLhgiNI/AAAAAAAAA9M/fjYaHy5cjMQ/s1600/coffee_cup.png) no-repeat  center left;" onclick="javascript:window.location.href='SitiosComer.php'">Sitios donde comer</li>
