		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/comidaImage.png" alt=""></figure>
							<h2>SITIOS PARA COMER<span> </span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
										<li style="cursor:pointer" onclick="window.open('http://www.restalo.es/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/restalo.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Restalo</span></h2><p>Restaurantes en Barcelona y en Madrid</p></li>
								
										<li style="cursor:pointer" onclick="window.open('http://www.guiarepsol.com/es_es/gastronomia/default.aspx')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/guiarepsol.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guiarepsol</span></h2><p>callejeros, carreteras, restaurantes</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.viamichelin.es/web/Restaurantes')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/guiamichelin.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guia Michelín</span></h2><p>guía de sitios donde comer</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.dondecomer.info')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/dondecomer.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Donde comer</span></h2><p>Guia de Restaurantes</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.eltenedor.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/eltenedor.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Eltenedor</span></h2><p>Restaurante Madrid, Barcelona</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.menus.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/menus.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Menus</span></h2><p>¿donde quieres comer hoy?</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.comerporlapatilla.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/comerporlapatilla.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Comer por la patilla</span></h2><p>Comer gratis, degustaciones y ferias gastronómicas</p></li>
