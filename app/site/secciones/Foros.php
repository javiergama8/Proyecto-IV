				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/forosImage.gif" alt=""></figure>
							<h2>FOROS<span> Conecta y habla con otras personas</span></h2>
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
								...
								<li style="cursor:pointer" onclick="window.open('http://www.forocoches.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=forocoches.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 ForoCoches</span></h2><p>no sólo se habla de coches, aunque es uno de los temas principales</p></li>
								 
								  <li style="cursor:pointer" onclick="window.open('http://taringa.net/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=taringa.net) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Taringa</span></h2><p>una de las mayores comunidades para compartir conocimientos</p></li>

								 <li style="cursor:pointer" onclick="window.open('http://es.answers.yahoo.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=yahoo.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Y Respuestas</span></h2><p>plantea tu pregunta y espera a que te respondan</p></li>
								 
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.pordescargadirecta.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/pordescargadirecta.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 PordescargaDirecta</span></h2><p>un poco de todo, música, cine, series, videojuegos, ...</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://debates.coches.net/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/cochesnet.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Coches</span></h2><p>busca coche, comparte tus dudas, ruidos ... de tu coche</p></li>
								 ...
								 Los viajeros</span></h2><p>comenta con otros usuarios tus viajes, recomienda</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.enfemenino.com')"><h2><span style="background:url(http://4.bp.blogspot.com/-N3-TWO80NS4/UV2mWfHLlQI/AAAAAAAABFI/wzSvNwyJvZQ/s320/enfemenino.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 EnFemenino</span></h2><p>se habla y consulta sobre moda, salud, belleza, adelgazar, tests...</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://foro.mundorecetas.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/mundorecetas.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Mundorecetas</span></h2><p>todo sobre la cocina, con foros para consultar dudas ...</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.forobeta.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=forobeta.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 ForoBeta</span></h2><p>dedicado al mundo de los bloggers, social media, seo, ... </p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.forosdelweb.com')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=forosdelweb.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 ForosdelWeb</span></h2><p>comenta, discute sobre diseño y desarrollo web</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.htcmania.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/htcmania.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Htcmania</span></h2><p>si te gusta los smartphones pásate por esta comunidad</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://www.elhacker.net')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/elhacker.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Elhacker</span></h2><p>todo una colección de trucos de todo tipo</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://desarrolloweb.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=desarrolloweb.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Desarrolloweb</span></h2><p>a tener en cuenta si quieres aprender a desarrollar web</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://soporte.miarroba.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/miarroba.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 MiArrobawebmasters</span></h2><p>pásate por aquí si te gusta la tecnología ...</p></li>
								 <li style="cursor:pointer" onclick="window.open('http://answers.microsoft.com/es-es')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=microsoft.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Microsoft Answers</span></h2><p>busca y encuentra solución a tu problema con window, ie, ...</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.todoexpertos.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/todoexpertos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 TodoExpertos</span></h2><p>muchos expertos unidos para solucionarte tus dudas</p></li>
								 
								 <li style="cursor:pointer" onclick="window.open('http://www.foro-ciudad.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=foro-ciudad.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
								 Foro-ciudad</span></h2><p>el foro de tu pueblo o ciudad</p></li>
