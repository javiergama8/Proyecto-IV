		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/redessociales.png" alt=""></figure>
							<h2>REDES SOCIALES<span> ¡Comparte tus experiencias!</span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
			 		<section id="content">
						...
						<div id="iniciales" class="inicorreo">
						 	<ul>	

						  <li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1TC1OUURhNTFNZVk) no-repeat  top center;background-size:20px 20px;" title="Facebook" onclick="javascript:window.open('http://facebook.com')">Facebook</li>
						  
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cWV4dnFleXlwSGc) no-repeat  top center;background-size:16px 16px;" title="Twitter" onclick="javascript:window.open('http://twitter.com')">Twitter</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1NUw0dnRZbXNzQ3M) no-repeat  top center;background-size:16px 16px;" title="Tuenti" onclick="javascript:window.open('http://tuenti.com')">Tuenti</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1bFJMNEhXVlNrQ28) no-repeat  top center;background-size:16px 16px;" title="Google+" onclick="javascript:window.open('http://plus.google.com')">Google+</li>

								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1bm55UG44dGtJWmc) no-repeat  top center;background-size:16px 16px;" title="Linkedin" onclick="javascript:window.open('http://linkedin.com')">Linkedin</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1SFJuQkRoRG10R3c) no-repeat  top center;background-size:16px 16px;" title="Imgur" onclick="javascript:window.open('http://imgur.com')">Imgur</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WjdIcTJKTmY1NXc) no-repeat  top center;background-size:16px 16px;" title="Flickr" onclick="javascript:window.open('http://flickr.com')">Flickr</li>
								
						  <li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1emlwLWtJR2s2azA) no-repeat  top center;background-size:16px 16px;" title="Pinterest" onclick="javascript:window.open('http://pinterest.com/')">Pinterest</li>   			

								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WklBU2N5ZFp2WWc) no-repeat  top center;" title="Panoramio" onclick="javascript:window.open('http://panoramio.com')">Panoramio</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1YUluTDhFVUp3LUE) no-repeat  top center;" title="Latitude" onclick="javascript:window.open('http://www.google.com/latitude/')">Latitude</li>  
								 			
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WldnZEdJNmJRNWs) no-repeat  top center;background-size:16px 16px;" title="Hi5" onclick="javascript:window.open('http://hi5.com')">Hi5</li>

								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1RHVFNVpPcXBaSUE) no-repeat  top center;" title="EntreLectores" onclick="javascript:window.open('http://www.entrelectores.com')">EntreLectores</li>  
								          			
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1TGhvN2ZRRlp3eVU) no-repeat  top center;" title="Moterus" onclick="javascript:window.open('http://www.moterus.es/')">Moterus</li>    
								        			
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1dUNmRkoyN1RSMDg) no-repeat  top center;background-size:16px 16px;" title="Myspace" onclick="javascript:window.open('http://myspace.com')">Myspace</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1RWJBU3BDWWlUY3M) no-repeat  top center;background-size:16px 16px;" title="Sonico" onclick="javascript:window.open('http://www.sonico.com')">Sonico</li>

								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Zld3dHh5WXJ5Rk0) no-repeat  top center;background-size:16px 16px;" title="Badoo" onclick="javascript:window.open('http://badoo.com')">Badoo</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1aUpOTFNrbUFWalE) no-repeat  top center;background-size:16px 16px;" title="Meetic" onclick="javascript:window.open('http://www.meetic.es/')">Meetic</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1M184QkRVd0I0Y0U) no-repeat  top center;background-size:16px 16px;" title="MeeticAffinity" onclick="javascript:window.open('http://www.meeticaffinity.es')">MeeticAffinity</li>
								
								<li style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1OWhURmR0eWF1cHM) no-repeat  top center;background-size:16px 16px;" title="Zoosk" onclick="javascript:window.open('https://www.zoosk.com/')">Zoosk</li>   			
