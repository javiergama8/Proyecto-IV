				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/correo.png" alt=""></figure>
							<h2>CORREO<span> No dejes de leer tus mensajes.</span></h2>
					...
					<section id="content">
							...
							<div id="iniciales" class="inicorreo">
								 <ul>	
									...
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.google.com) no-repeat  top center;background-size:16px 16px;" title="accede a tu cuenta de correo en gmail" onclick="javascript:window.open('https://www.google.com/accounts/ServiceLogin?service=mail&amp;passive=true&amp;rm=false&amp;continue=http%3A%2F%2Fmail.google.com%2Fmail%2F%3Fhl%3Des%26tab%3Dwm%26ui%3Dhtml%26zy%3Dl&amp;bsv=1eic6yu9oa4y3&amp;scc=1&amp;ltmpl=default&amp;ltmplcache=2&amp;hl=es')">Gmail</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=yahoo.com) no-repeat  top center;background-size:16px 16px;" title="consulta tus emails" onclick="javascript:window.open('https://login.yahoo.com/config/login_verify2?.src=ym&amp;.intl=es')">Yahoo</li>
									<li style="background:url(http://2.bp.blogspot.com/-XBV-TsTkRPw/UV2mSrBmWoI/AAAAAAAABC4/SUX1iZay1u8/s320/bing.png) no-repeat  top center;" title="outlook el nuevo hotmail" onclick="javascript:window.open('http://www.outlook.com')">Outlook</li>
									<li style="background:url(http://2.bp.blogspot.com/-M48HYNXdvOU/UV4EWJ_RFxI/AAAAAAAABSs/2zWT5FZodAg/s320/gmx.png) no-repeat  top center;" title="una alternativa a las grandes cuentas de correo" onclick="javascript:window.open('http://gmx.es')">Gmx</li>
									<li style="background:url(http://2.bp.blogspot.com/-3vR7xJnjyGk/UV4EXhL8M2I/AAAAAAAABT4/tpBF-j8JbYI/s320/movistar.png) no-repeat  top center;" title="tu correo movistar" onclick="javascript:window.open('https://movistar.es')">Movistar</li>
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/vodafone.png) no-repeat  top center;" title="tu correo vodafone" onclick="javascript:window.open('http://www.vodafone.es')">Vodafone</li>
									<li style="background:url(http://www.google.com/s2/favicons?domain=orange.es) no-repeat  top center;background-size:16px 16px;" title="tu correo orange" onclick="javascript:window.open('http://orange.es/')">Orange</li>
									<li style="background:url(http://2.bp.blogspot.com/-1oozsCFnU9Y/UNq1LbrkKhI/AAAAAAAAA5M/7GshjCm3Ltc/s1600/ono.png) no-repeat  top center;" title="tu correo ono" onclick="javascript:window.open('http://www.ono.com')">Ono</li>
