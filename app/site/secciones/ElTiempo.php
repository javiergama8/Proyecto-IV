		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/tiempo.png" alt=""></figure>
							<h2>EL TIEMPO<span> ¿Soleado, Nublado, LLuvia...?</span></h2>
							<h1>Todas tus páginas para consultar el tiempo.</h1>
					...
					<section id="content">
							...
							<div id="iniciales" class="inicorreo">
								 <ul>	
									...
									<li style="background:url(http://4.bp.blogspot.com/-WH-r4ZofOV4/T4E9NNlox4I/AAAAAAAAARU/Tih-ykcEK_U/s200/aemet.png) no-repeat  top center;" title="Aemet" onclick="javascript:window.open('http://www.aemet.es/es/portada')">Aemet</li>
									
									<li style="background:url(http://4.bp.blogspot.com/-BKcB2bJjPqY/UV2mWE4QBMI/AAAAAAAABFA/ktEjZMAmRQY/s320/eltiempo.png) no-repeat  top center;" title="El tiempo" onclick="javascript:window.open('http://eltiempo.es')">Eltiempo</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=weather.com) no-repeat  top center;background-size:16px 16px;" title="Weather.espanol" onclick="javascript:window.open('http://espanol.weather.com')">Weather.espanol</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.tiempo.com) no-repeat  top center;background-size:16px 16px;" title="Tiempo" onclick="javascript:window.open('http://www.tiempo.com')">Tiempo</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.meteo.cat) no-repeat  top center;background-size:16px 16px;" title="Meteo.cat" onclick="javascript:window.open('http://www.meteo.cat')">Meteo.cat</li>
									
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/meteogalicia.png) no-repeat  top center;" title="Meteogalicia" onclick="javascript:window.open('http://www.meteogalicia.es')">Meteogalicia</li>
									
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/euskalmet.png) no-repeat  top center;" title="Euskalmet" onclick="javascript:window.open('http://www.euskalmet.euskadi.net/')">Euskalmet</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.infonieve.es) no-repeat  top center;background-size:16px 16px;" title="Infonieve" onclick="javascript:window.open('http://www.infonieve.es')">Infonieve</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=google.com) no-repeat  top center;background-size:16px 16px;" title="GoogleMaps" onclick="javascript:window.open('http://maps.google.es/')">GoogleMaps</li>
									
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/pt.png) no-repeat  top center;" title="Meteo.pt" onclick="javascript:window.open('http://www.ipma.pt/pt/')">Meteo.pt</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=weather.com) no-repeat  top center;background-size:16px 16px;" title="Weather" onclick="javascript:window.open('http://www.weather.com')">Weather</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.metoffice.gov.uk) no-repeat  top center;background-size:16px 16px;" title="Metoffice" onclick="javascript:window.open('http://www.metoffice.gov.uk')">Metoffice</li>
									
									<li style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/fr.png) no-repeat  top center;" title="Meteofrance" onclick="javascript:window.open('http://www.meteofrance.com/')">Meteofrance</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.meteo.it) no-repeat  top center;background-size:16px 16px;" title="Meteo.it" onclick="javascript:window.open('http://www.meteo.it')">Meteo.it</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.wetter.de) no-repeat  top center;background-size:16px 16px;" title="Wetter" onclick="javascript:window.open('http://www.wetter.de')">Wetter</li>
									
									<li style="background:url(http://www.google.com/s2/favicons?domain=www.meteored.mx) no-repeat  top center;background-size:16px 16px;" title="Meteored" onclick="javascript:window.open('http://www.meteored.mx')">Meteored</li>
