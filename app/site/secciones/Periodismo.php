					...
					<section id="content">
							<style>
								*           {margin:0;padding:0;}
								...
								#detalleff h2 span {	font-size:16px;}
							...
							<div id="iniciales" class="subindices">
				 				<ul>	

									<li style="background:url(http://4.bp.blogspot.com/-oYE9LL3c9WE/T4FE2ZgrDKI/AAAAAAAAATA/c6ywQ921OFY/s200/news.png) no-repeat  center left;" title="Noticias" onclick="javascript:window.location.href='Noticias.php'">Noticias</li>
									
									<li style="background:url(http://4.bp.blogspot.com/-vQKFzfZLOtw/T4FFHkveJFI/AAAAAAAAATM/qzaTvvQP5O0/s200/football.png) no-repeat  center left;" title="Deportes" onclick="javascript:window.location.href='NoticiasDeportivas.php'">Deportes</li>
									
									<li style="background:url(http://2.bp.blogspot.com/-cydi2cx85H0/T4FFQvu41YI/AAAAAAAAATY/sG0xO2m4Ahs/s200/red_heart.png) no-repeat  center left;" title="El corazón" onclick="javascript:window.location.href='ElCorazon.php'">El mundo del corazón</li>
									<li style="background:url(http://1.bp.blogspot.com/-wSU4Az9npT8/T4FFYzAGGQI/AAAAAAAAATk/x_YpbRePmxU/s200/computer.png) no-repeat  center left;" title="Tecnología" onclick="javascript:window.location.href='Tecnología.php'">Tecnología</li>
									
									<li style="background:url(http://1.bp.blogspot.com/-gnZNGOp3bZU/T4FFhYzU9MI/AAAAAAAAATw/e2XaVmiC5AU/s200/mundomotor.png) no-repeat  center left;" title="Motor" onclick="javascript:window.location.href='MundoDelMotor.php'">Mundo del motor</li>
									
									<li style="background:url(http://2.bp.blogspot.com/-zYufF1yGikU/T4FFzGAiBPI/AAAAAAAAAUI/3cH6vkBrVNY/s200/attachment.png) no-repeat  center left;" title="Humor" onclick="javascript:window.location.href='Humor.php'">Humor</li>   			
									<li style="background:url(http://4.bp.blogspot.com/-hf8d06pLP8I/T4FF8UJvcAI/AAAAAAAAAUU/X-W1I2CeYPI/s200/euro_currency_sign.png) no-repeat  center left;" title="Economía" onclick="javascript:window.location.href='Economia.php'">Economía</li>
									
									<li style="background:url(http://3.bp.blogspot.com/-ZnpLGEsRYCo/T4FGN7EUG6I/AAAAAAAAAUs/2xDay4JFXAg/s200/artwork.png) no-repeat  center left;" title="Decoración" onclick="javascript:window.location.href='Decoracion.php'">Todo sobre decoración</li>
									
									
									<li style="background:url(http://1.bp.blogspot.com/-rczcsTAiLlE/T4FH39NqRKI/AAAAAAAAAVQ/xukhUhOcY8U/s200/edit.png) no-repeat  center left;" title="Blogs" onclick="javascript:window.location.href='Blogs.php'">BLOGS</li>
