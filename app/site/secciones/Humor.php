				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/humorImage.png" alt=""></figure>
							<h2>HUMOR<span> ¡No dejes de reír!</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 ...
									 <li style="cursor:pointer" title="El jueves" onclick="window.open('http://www.eljueves.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Y3hjRWp2a2J4X3M) no-repeat center left;background-size:16px 16px;padding-left:25px;">El Jueves</span></h2></li>
									 
									 <li style="cursor:pointer" title="El Mundo TOday" onclick="window.open('http://www.elmundotoday.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WUJrak9LOFBmbGM) no-repeat center left;background-size:16px 16px;padding-left:25px;">ElmundoToday</span></h2></li>
									 
									 <li style="cursor:pointer" title="Visto en FB" onclick="window.open('http://www.vistoenlasredes.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1UmZac3FkbDNDaE0) no-repeat center left;background-size:16px 16px;padding-left:25px;">VistoenFB</span></h2></li>
									 
									 <li style="cursor:pointer" title="Cuanto Cabron" onclick="window.open('http://www.cuantocabron.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1cDZyYWJvVm1NY28) no-repeat center left;background-size:16px 16px;padding-left:25px;">Cuantocabron</span></h2></li>
									 
									 <li style="cursor:pointer" title="Tenía que decirlo" onclick="window.open('http://www.teniaquedecirlo.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WWxMTHFsb3Q2MUk) no-repeat center left;background-size:16px 16px;padding-left:25px;">TeniaqueDecirlo</span></h2></li>
									 
									 <li style="cursor:pointer" title="No tengo tele" onclick="window.open('http://www.notengotele.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1OGxWcEp4MDlkeEU) no-repeat center left;background-size:16px 16px;padding-left:25px;">NotengoTele</span></h2></li>
									 
									 <li style="cursor:pointer" title="Vaya GIF" onclick="window.open('http://www.vayagif.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Z3k1OE5XdFJUZVU) no-repeat center left;background-size:16px 16px;padding-left:25px;">VayaGif</span></h2></li>
									 
									 <li style="cursor:pointer" title="FrikiPedia" onclick="window.open('http://www.frikipedia.es')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Ynpsb0RWZ0lqZ00) no-repeat center left;background-size:16px 16px;padding-left:25px;">Frikipedia</span></h2></li>
									 
									 
									 <li style="cursor:pointer" title="Goma Espuma" onclick="window.open('http://www.gomaespuma.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1ekN3ZDhJOWZNR1E) no-repeat center left;background-size:16px 16px;padding-left:25px;">GomaEspuma</span></h2></li>
