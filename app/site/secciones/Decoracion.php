				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/casaImage.png" alt=""></figure>
							<h2>DECORACIÓN<span> Actualiza y renueva tu hogar</span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
									 ...
									 <li style="cursor:pointer" title="Facilisimo" onclick="window.open('http://www.facilisimo.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1THZuWm1rd2lRV00) no-repeat center left;background-size:16px 16px;padding-left:25px;">Facilisimo</span></h2></li>
									 
									 <li style="cursor:pointer" title="Hogar" onclick="window.open('http://www.revistahogar.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1WjZPQm9Xa1ZoaVE) no-repeat center left;background-size:16px 16px;padding-left:25px;">Hogar</span></h2></li>
									 
									 <li style="cursor:pointer" title="Hogar Útil" onclick="window.open('http://www.hogarutil.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1SjBCU2MzYmJBcmc) no-repeat center left;background-size:16px 16px;padding-left:25px;">HogarUtil</span></h2></li>
									 
									 <li style="cursor:pointer" title="El mueble" onclick="window.open('http://www.elmueble.com/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Mkw1T2l3dUtCdjA) no-repeat center left;background-size:16px 16px;padding-left:25px;">Elmueble</span></h2></li>
									 
									 <li style="cursor:pointer" title="Espacio Hogar" onclick="window.open('http://espaciohogar.com')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1VDVULXY1RlNnSlU) no-repeat center left;background-size:16px 16px;padding-left:25px;">EspacioHogar</span></h2></li>
									 
									 <li style="cursor:pointer" title="Casa Diez" onclick="window.open('http://casadiez.elle.es/')"><h2><span style="background:url(http://drive.google.com/uc?export=view&id=0B8nOgCL0Aof1Z2Rqa1BuTEJGT3M) no-repeat center left;background-size:16px 16px;padding-left:25px;">CasaDiez</span></h2></li>
