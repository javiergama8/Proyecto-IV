		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/dormirImage.png" alt=""></figure>
							<h2>SITIOS PARA DORMIR<span> </span></h2>
			...
			<div class="body7">
				...
				<!--EMPIEZO LAS SECCIONES-->
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
										<li style="cursor:pointer" onclick="window.open('http://www.trivago.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/trivago.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Trivago</span></h2><p>comparación de precios de hoteles</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.booking.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/booking.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Booking</span></h2><p>hoteles en todo el mundo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.hoteles.es')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/hoteles.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Hoteles</span></h2><p>Hoteles por todo el mundo, precios actualizados</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.ratestogo.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/ratestogo.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Ratestogo</span></h2><p>Ofertas de Hoteles de Último Minuto</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.airbnb.es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.airbnb.es) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Airbnb</span></h2><p>encuentra alojamiento en casas alquiladas para vacaciones</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.9flats.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/9flats.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										9flats</span></h2><p>Los mejores lugares donde alojarse</p></li>
										<li style="cursor:pointer" onclick="window.open('http://es.rentalia.com/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/rentalia.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Rentalia</span></h2><p>Alquiler de vacaciones directamente al propietario.</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.quehoteles.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/quehoteles.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										QueHoteles</span></h2><p>Sólo hoteles.</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.accorhotels.com/es/espana/index.shtml')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/accorhotels.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Accorhotels</span></h2><p>Reserva de hotel</p></li>

										<li style="cursor:pointer" onclick="window.open('http://www.tendumi.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/tendumi.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Tendumi</span></h2><p>Campings en España</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.campings.net')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/guiadecampings.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Guia de Campings</span></h2><p>Guia de Campings España</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.1000albergues.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/1000albergues.jpg) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Albergues</span></h2><p>alojamiento barato, albergues ...</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.campingsalon.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/campingsalon.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										CampingsSalon</span></h2><p>Camping, autocaravanas, caravanas</p></li>

										<li style="cursor:pointer" onclick="window.open('http://www.homeforhome.com/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.homeforhome.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										HomeforHome</span></h2><p>Intercambia tú casa</p></li>
										<li style="cursor:pointer" onclick="window.open('https://www.intercambiocasas.com/es/')"><h2><span style="background:url(http://www.google.com/s2/favicons?domain=www.intercambiocasas.com) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										IntercambioCasas</span></h2><p>Intercambia tú casa</p></li>
