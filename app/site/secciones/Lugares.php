		...
		<!-- contenido -->
			<div class="body5">
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							<figure class="left"><img width=50 height=50 src="../images/lugares.png" alt=""></figure>
							<h2>LUGARES<span> </span></h2>
					...
					<section id="content">
							...
							<div id="detalleff">
								  <ul>
										...
										<li style="cursor:pointer" onclick="window.open('http://www.spain.info')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/spain.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Spain</span></h2><p>Información turística de España</p></li>

										<li style="cursor:pointer" onclick="window.open('http://www.wondersoftheworld.tv/')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/wondersoftheworld.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										WondersOfTheWorld</span></h2><p>maravillas del mundo, videos, enlaces, etc ...</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.lugaresfamosos.com')"><h2><span style="background:url(https://googledrive.com/host/0B-kX9VziyPrzY0NEWV83Rlh2RDA/logo/lugaresfamosos.png) no-repeat center left;background-size:16px 16px;padding-left:25px;">
										Lugares Famosos</span></h2><p>Lugares famosos del mundo</p></li>
								
										<li style="cursor:pointer" onclick="window.open('http://www.andalucia.org')"><h2><span class="noexiste">
										Andalucía</span></h2><p>Web oficial de turismo de Andalucía</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismodearagon.com')"><h2><span class="noexiste">
										Aragón</span></h2><p>Turismo de Aragón.</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismoasturias.es/')"><h2><span class="noexiste">
										Asturias</span></h2><p>Portal oficial de turismo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.illesbalears.es')"><h2><span class="noexiste">
										Baleares</span></h2><p>Islas Baleares Mallorca, Menorca, Ibiza y Formentera</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.bilbaoturismo.net/')"><h2><span class="noexiste">
										Bilbao</span></h2><p>Bilbao Turismo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismodecantabria.com')"><h2><span class="noexiste">
										Cantabria</span></h2><p>Cantabria Infinita</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismodecanarias.com')"><h2><span class="noexiste">
										Canarias</span></h2><p>Visita la Web Oficial de Turismo de Canarias</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismocastillalamancha.com')"><h2><span class="noexiste">
										Castilla la Mancha</span></h2><p>Web oficial de Turismo de Castilla-La Mancha</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismocastillayleon.com')"><h2><span class="noexiste">
										Castilla y León</span></h2><p>Turismo Castilla y León</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.catalunya.com/')"><h2><span class="noexiste">
										Catalunya</span></h2><p>cataluña turismo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.ceuta.es')"><h2><span class="noexiste">
										Ceuta</span></h2><p>Conoce Ceuta</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.comunitatvalenciana.com')"><h2><span class="noexiste">
										C. Valenciana</span></h2><p>Web oficial comunidad valenciana de turismo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://turismo.euskadi.net/')"><h2><span class="noexiste">
										Euskadi</span></h2><p>Euskadi con mucho gusto</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismoextremadura.com')"><h2><span class="noexiste">
										Extremadura</span></h2><p>Portal de Turismo de Extremadura</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turgalicia.es/default.asp?cidi=E')"><h2><span class="noexiste">
										Galicia</span></h2><p>galicia turismo</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.ibiza.es/portal/index.php?option=com_content&amp;view=category&amp;layout=blog&amp;id=67&amp;Itemid=258&amp;lang=es')"><h2><span class="noexiste">
										Ibiza</span></h2><p>Historia de la ciudad</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.lariojaturismo.com')"><h2><span class="noexiste">
										La Rioja</span></h2><p>Portal de Turismo de La Rioja</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismomadrid.es')"><h2><span class="noexiste">
										Madrid</span></h2><p>Turismo en la Comunidad de Madrid</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.melillaturismo.com')"><h2><span class="noexiste">
										Melilla</span></h2><p>Promoción Turística de Melilla</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.murciaturistica.es')"><h2><span class="noexiste">
										Murcia</span></h2><p>Murcia turistica</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.turismo.navarra.es')"><h2><span class="noexiste">
										Navarra</span></h2><p>Web Oficial de Turismo de Navarra</p></li>
										<li style="cursor:pointer" onclick="window.open('http://www.palmademallorca.es/IMI/PORTAL/PRD/lact_d10_v1.jsp?codMenu=850&amp;agrupacion=03&amp;language=es')"><h2><span class="noexiste">
										Palma de Mallorca</span></h2><p>Ajuntament de Palma</p></li>
