				...
				<div class="body6">
					<div class="main">
						<div class="wrapper">
							...
							<figure class="left"><img width=50 height=50 src="../images/television.png" alt=""></figure>
							<h2>TELEVISIÓN<span> Todos los canales y programaciones</span></h2>
					...
					<section id="content">
							...
							<div id="iniciales" class="subindices1">
								 <ul>	
									...
									<li style="background:url(http://4.bp.blogspot.com/-NutfXt4CfkY/UbD_Wdm1pKI/AAAAAAAABag/vxrmvSVDBh8/s1600/enlatele.png) no-repeat  center left;" onclick="javascript:window.open('http://www.teletexto.com/')">Teletexto</li>
									
									<li style="background:url(http://1.bp.blogspot.com/-szYgwaLzMY4/T4FIWTe82AI/AAAAAAAAAVo/cvODByvXpeI/s200/canales.png) no-repeat  center left;" onclick="javascript:window.location.href='CanalesDeTelevision.php'">Canales de televisión</li>
